 ...
 */
public class DeleteMigrationDataInPtks extends TestBase {
    ...
    @Test(description = "Удалить Базовое отделение",dataProvider = "getDataFromExcel", priority=11)
    ...
    public void DeleteBaseDepartment(BaseDepartmentModel bo) throws SQLException, IntegrationException {
        bo.setOpfrId(opfrHelper.getByCode(bo.getOpfrCode()).getId());
        CheckResult res = boHelper.delete(bo);
        ...
        res = journalChangeDataHelper.checkExistChangeData(bo.getId(),
                ...
                PtksEnumeration.JournalChangeDataOperationType.DELETE.getValue());
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    }

    @Test(description = "Удалить Территориальный орган",dataProvider = "getDataFromExcel", priority=11)
    ...
    public void DeleteTerOrgan(TerOrganModel terOrgan) throws SQLException, IntegrationException {

        terOrgan.setOpfrId(opfrHelper.getByCode(terOrgan.getOpfrCode()).getId());
        CheckResult res = terOrganHelper.delete(terOrgan);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить Районный орган",dataProvider = "getDataFromExcel", priority=10)
    ...
    public void DeleteTerDepartmentPFR(TerDepartmentPFRModel terDepartment) throws SQLException, IntegrationException {
        ...
        CheckResult res = terDepartmentPFRHelper.delete(terDepartment);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить ОКАТО",dataProvider = "getDataFromExcel", priority=2)
    ...
    public void DeleteOkato(OkatoModel okato) throws SQLException, IntegrationException {
        ...
        CheckResult res = okatoHelper.delete(okato);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить ОПФ",dataProvider = "getDataFromExcel", priority=2)
    @DataProviderParams("fileName="+ fileName +";tabName="+ tabName +";class="+ "OpfModel" +";testTableName="+ "CreateMigrationDataInPtks.CreateOpf")
    public void DeleteOpf(OpfModel opf) throws SQLException, IntegrationException {
        CheckResult res = opfHelper.delete(opf);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить ОКВЭД",dataProvider = "getDataFromExcel", priority=2)
    ...
    public void DeleteOkved(OkvedModel okved) throws SQLException, IntegrationException {
        CheckResult res = okvedHelper.delete(okved);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить КЛАДР.Субъект РФ",dataProvider = "getDataFromExcel", priority=9)
    ...
    public void DeleteKladrRegion(RegionModel region) throws SQLException, IntegrationException {
        CheckResult res = regionHelper.delete(region);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить КЛАДР.Административный район",dataProvider = "getDataFromExcel", priority=8)
    ...
    public void DeleteKladrAdmTerritory(AdmTerritoryModel admTerritory) throws SQLException, IntegrationException {
        ...
        CheckResult res = admTerritoryHelper.delete(admTerritory);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить КЛАДР.Населенный пункт",dataProvider = "getDataFromExcel", priority=7)
    @DataProviderParams("fileName="+ fileName +";tabName="+ tabName +";class="+ "CityModel" +";testTableName="+ "CreateMigrationDataInPtks.CreateCity")
    public void DeleteKladrCity(CityModel city) throws SQLException, IntegrationException {
        ...
        CheckResult res = cityHelper.delete(city);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить КЛАДР.Город",dataProvider = "getDataFromExcel", priority=6)
      @DataProviderParams("fileName="+ fileName +";tabName="+ tabName +";class="+ "TownModel" +";testTableName="+ "CreateMigrationDataInPtks.CreateTown")
      public void DeleteKladrTown(TownModel town) throws SQLException, IntegrationException {
        ...
        CheckResult res = townHelper.delete(town);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить КЛАДР.Улица",dataProvider = "getDataFromExcel", priority=5)
    ...
    public void DeleteKladrStreet(StreetModel street) throws SQLException, IntegrationException {
        ...
        CheckResult res = streetHelper.delete(street);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить КЛАДР.Улица.Список диапазонов",dataProvider = "getDataFromExcel", priority=4)
    ...
    public void DeleteKladrStreetDepartment(StreetDepartmentModel streetDepartment) throws SQLException, IntegrationException {
        ...
        CheckResult res = streetDepartmentHelper.delete(streetDepartment);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    }

    @Test(description = "Удалить КЛАДР.Улица.Список диапазонов.Список домов",dataProvider = "getDataFromExcel", priority=3)
    ...
    public void DeleteKladrStreetHouses(StreetHousesModel streetHouses) throws SQLException, IntegrationException {
        ...
        CheckResult res = streetHousesHelper.delete(streetHouses);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    }

    @Test(description = "Удалить Вид регистрации",dataProvider = "getDataFromExcel", priority=2)
    ...
    public void DeleteRegistrationKind(RegistrationKindModel registrationKind) throws SQLException, IntegrationException {

       CheckResult res = registrationKindHelper.delete(registrationKind);
       assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить Регистрирующий орган",dataProvider = "getDataFromExcel", priority=2)
    ...
    public void DeleteRegistrationDepartment(RegistrationDepartmentModel registrationDepartment) throws SQLException, IntegrationException {

        CheckResult res = registrationDepartmentHelper.delete(registrationDepartment);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить ИФНС",dataProvider = "getDataFromExcel", priority=2)
    @DataProviderParams("fileName="+ fileName +";tabName="+ tabName +";class="+ "IfnsModel" +";testTableName="+ "CreateMigrationDataInPtks.CreateIfns")
    public void DeleteIfns(IfnsModel ifns) throws SQLException, IntegrationException {

        CheckResult res = ifnsHelper.delete(ifns);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
    ...
    @Test(description = "Удалить Плательщика",dataProvider = "getDataFromExcel", priority=1)
    ...
    public void DeleteInsurer(InsurerModel insurer) throws SQLException, IntegrationException {
        ...
        CheckResult res = insurerHelper.delete(insurer);
        assertTrue(res.getIsSuccess(), res.getMessageTest());
