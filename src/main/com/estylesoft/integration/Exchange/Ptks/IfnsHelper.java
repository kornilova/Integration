...
public class IfnsHelper {
    ...
    public CheckResult delete(IfnsModel obj) throws IntegrationException {
        CheckResult res = new CheckResult();
        res.setIsSuccess(true);
        ...
        ifnsDAO.delete(obj.getId());

        if (ifnsDAO.getById(obj.getId()) != null) {
            res.setIsSuccess(false);
            res.setMessageTest("ERROR: STH_TERRITORY_DPT_FNS is not deleted.");
        }
