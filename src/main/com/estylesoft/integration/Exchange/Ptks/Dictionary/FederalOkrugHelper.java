...
import com.estylesoft.integration.Database.mybatis.Ptks.Dictionary.FederalOkrugDAO;
import com.estylesoft.integration.IntegrationException;
import com.estylesoft.integration.Model.Ptks.Dictionary.FederalOkrugModel;
...
public class FederalOkrugHelper {
    ...
    public CheckResult create(FederalOkrugModel obj) throws IntegrationException {
        ...
        if (obj.getId()==null) {
                    ...
                    res.setMessageTest("ERROR: STH_FED_OKRUG is not inserted.");
                }
        return res;
    }
    ...
    public CheckResult delete(FederalOkrugModel obj) throws IntegrationException {
        ...
        if (federalOkrugDAO.getById(obj.getId()) != null) {
            res.setIsSuccess(false);
            res.setMessageTest("ERROR: STH_FED_OKRUG is not deleted.");
        }
