...
public class OkatoHelper {
    ...
    public CheckResult delete(OkatoModel obj) throws IntegrationException {
        CheckResult res = new CheckResult();
        res.setIsSuccess(true);
        ...
        okatoDAO.delete(obj.getId());

        if (okatoDAO.getById(obj.getId()) != null) {
            res.setIsSuccess(false);
            res.setMessageTest("ERROR: STH_OKATO is not deleted.");
        }
